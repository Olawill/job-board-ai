      ...
      <div className="space-y-4">
        <div className="flex gap-4 items-start">
          ...
          <div className="ml-auto flex items-center gap-4">
            {jobListing.postedAt != null && (
              <div className="text-sm font-medium text-primary @max-lg:hidden">
                {jobListing.postedAt.toLocaleDateString()}
              </div>
            )}
    ...
    <Dialog>
      ...
      <DialogContent className="md:max-w-3xl max-h-calc([100%-2rem)] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Applying for a job cannot be undone and can only be done once for
            each job listing.
          </DialogDescription>
        </DialogHeader>
